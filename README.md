...
The packages in the `robot_navigation` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic robot_navigation` on `Mon, 03 Dec 2018 21:02:35 -0000`
