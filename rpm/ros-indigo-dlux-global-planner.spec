Name:           ros-indigo-dlux-global-planner
Version:        0.2.0
Release:        0%{?dist}
Summary:        ROS dlux_global_planner package
...
BuildRequires:  ros-indigo-global-planner-tests
...
BuildRequires:  ros-indigo-nav-grid-pub-sub
